...
import { Download, Printer, ExternalLink, QrCode, X, Copy, Check } from "lucide-react";
...
export default function TableQrModal({ table, isOpen, onClose }: TableQrModalProps) {
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      ...
      <html>
        ...
        <body>
          <div class="container">
            <div class="brand">The Culinary Ledger</div>
  ...
  const handleDownload = () => {
    ...
    img.onload = () => {
      ...
      if (ctx) {
        ...
        ctx.fillText("The Culinary Ledger", canvas.width / 2, 160);
