...
function AlertDialogTrigger({ ...props }: Readonly<AlertDialogPrimitive.Trigger.Props>) {
  return (
    <AlertDialogPrimitive.Trigger data-slot="alert-dialog-trigger" {...props} />
  )
}

function AlertDialogPortal({ ...props }: Readonly<AlertDialogPrimitive.Portal.Props>) {
  return (
...
function AlertDialogContent({
  ...
  size = "default",
  ...props
}: Readonly<AlertDialogPrimitive.Popup.Props & {
  size?: "default" | "sm"
}>) {
  return (
    <AlertDialogPortal>
...
function AlertDialogCancel({
  ...
  size = "default",
  ...props
}: Readonly<AlertDialogPrimitive.Close.Props &
