...
export default function QrPreviewPage({ params }: { params: Promise<{ tableId: string }> }) {
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      <html>
        ...
        <body>
          <div class="container">
            <div class="brand">Culinary Ledger</div>
  ...
  const handleDownload = () => {
    ...
    img.onload = () => {
      ...
      if (ctx) {
        ...
        ctx.fillText("Culinary Ledger", canvas.width / 2, 180);
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-gradient-to-br from-culinary-card via-white to-culinary-primary/10 border-2 border-culinary-border/50 rounded-3xl p-10 flex flex-col items-center justify-center shadow-xl shadow-culinary-primary/10">
          <div className="text-center space-y-8 w-full">
            ...
            >
              <QRCode value={`${typeof window !== 'undefined' && window.location.hostname !== 'localhost' ? window.location.origin : 'http://192.168.1.46:3000'}/menu/${table.id}`} size={250} level="H" fgColor="#B7791F" />
            </div>
          ...
          <div className="pt-6 border-t border-culinary-border/50">
            ...
            <div className="bg-culinary-background/50 p-4 rounded-xl border border-culinary-border/30 overflow-x-auto">
              <code className="text-xs text-blue-600 font-mono whitespace-nowrap">
                {`${typeof window !== 'undefined' && window.location.hostname !== 'localhost' ? window.location.origin : 'http://192.168.1.46:3000'}/menu/${table.id}`}
              </code>
            </div>
